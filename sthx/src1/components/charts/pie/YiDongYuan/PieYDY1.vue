  ...
  methods: {
    initChart() {
      ...
      let option = {
        ...
        // color: [ "#E0515F","#BCEB7F","#FF8800","#21af7c","#5599FF","#BBFF66"],21af7c,5eff7d（鲜绿）,4cc2ff(蓝色),7a9df1(蓝紫)，ec797e(红)
        //color: ["#41c2b7", "#00ffea","#21af7c",  "#00a6ae", "#01b06f"],
        color: ["#7a9df1", "#ec797e","#31ada5", "#4cc2ff","#5eff7d",  ],

  ...
  methods: {
    initChart() {
      ...
      let option = {
        ...
        color: ["#5eff7d", "#4cc2ff", "#7a9df1", "#31ada5","#FF8800","#ec797e",],
       //color: [,,"#66FF66"],
        tooltip: {
          show: true,
          formatter: "{b} : {c} 万吨 ({d}%)"
      ...
      this.myChart.on('click', function(params) {
          console.log('pieleftcenter params',params);
          //lee 待 为什么要用that=this
          //用this 会报this.$emit is not a function错误，应该与函数、this指向之类的有关
          that.$emit('pieClick',{
            name:params.name
          });
      });

...
<!--    右侧框-->
    <div class="rightdiv">
      <Box title="综合考核结果 △ E I" style="flex:1">
...
<!--中间气泡框-->
    <div class="center-control">
      <div v-show = "isshowPopup" class="attribute" :style="{'top':arrPosition.tableTop, 'left':arrPosition.tableLeft}">
...
&lt;!&ndash;            <span>标题</span>&ndash;&gt;
            <span style="float: right;padding-right: 5px;cursor: pointer;" class="close_pop" data-id=`+ uuid + `> X </span>
          </div>-->
...
<!--          图表容器 表示水质类别-->
<!--          <div title="散点图" v-show = "!isshowAttr"style="width:260px;height: 200px;">
&lt;!&ndash;            <lineSzjc  slot="content" :data="lineEIZSData" :changedom="isshowAttr"/>&ndash;&gt;
            <scatterSzjc  slot="content" :data="lineEIZSData" :changedom="isshowScatter"/>
          </div>-->
...
/*          that.arrPosition.tableLeft = pick.x -1000 +'px';
  ...
  mounted() {
      if(this.labelCollections){
          console.log('刷新后居然还有文字图层诶☹')
      }
    //初始化地图
